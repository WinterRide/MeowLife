      ...
      <View>
        <View style={{flex: 1, flexDirection: "row"}}>
          ...
          <View style={{flex: 1, padding: 10 }}>
            <Text style={{ fontWeight: "bold", fontSize: 18 }}>{products.species}</Text>
            <Text style={{ fontSize: 10 }}>{products.breed}</Text>
            <Text style={{ fontSize: 12, marginTop: 20 }}>{products.age} Years old</Text>
            <View style={{flex: 1}}>
                <Text style={{fontSize: 12, marginTop: 20}}>{formattedPrice}</Text>
            </View>
          </View>
