  ...
  const data = [
    {
      ...
      vaccine: [
        {
          name: "Rabies",
          photos : "https://images.pexels.com/photos/7630190/pexels-photo-7630190.jpeg?auto=compress&cs=tinysrgb&w=800"
        },
        {
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        <Pressable
          ...
          style={{ flexDirection: "row", alignItems: "center", backgroundColor: "#F15025", padding: 5, paddingLeft: 15, paddingRight: 15, borderRadius: 10 }}
        >
